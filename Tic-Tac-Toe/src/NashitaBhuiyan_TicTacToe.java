...
public class NashitaBhuiyan_TicTacToe extends JFrame{
	...
	public NashitaBhuiyan_TicTacToe() {
		...
		//add the tic-tac-toe board to the GUI
	...
	private boolean checkTie() {
		...
		for(int row=0; row<gameBoard.length; row++) {
			for(int col=0; col<gameBoard.length; col++) {
				...
				if(gameBoard[row][col].fName==null) 
					return false;
			}
		}
